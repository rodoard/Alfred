...
define('App',["backbone", "jquery", "marionette", "underscore"], function(Backbone) {
  var App, isMobile;
  isMobile = function() {
    var ua;
...
define('routers/AppRouter',["backbone", "marionette"], function(Marionette) {
...
define('controllers/Controller',["App", "backbone", "marionette"], function(App, Backbone) {
...
require(["App", "routers/AppRouter", "controllers/Controller"], function(App, AppRouter, Controller) {
